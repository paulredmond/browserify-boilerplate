...
},{"backbone":4,"backbone.babysitter":2,"backbone.wreqr":3,"underscore":6}],2:[function(require,module,exports){
// Backbone.BabySitter
// -------------------
// v0.1.8
//
...
},{"backbone":4,"underscore":6}],3:[function(require,module,exports){
...
},{"backbone.marionette":1}],8:[function(require,module,exports){
'use strict';
...
var _demoView = require('./demo-view');

var _demoView2 = _interopRequireDefault(_demoView);

var DemoApp = new _backboneMarionette.Application();

DemoApp.on('before:start', function () {

  var RegionContainer = _backboneMarionette.LayoutView.extend({
    el: '#app-container',
...
DemoApp.on('start', function () {
  var view = new _demoView2['default']();
  DemoApp.regions.main.show(view);
});

DemoApp.start();

},{"./demo-view":7,"backbone":4,"backbone.marionette":1,"jquery":5,"underscore":6}]},{},[8])
